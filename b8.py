...
\033[1;91m☞ Auther     : CORONA-VIRUS
\033[1;92m☞ WhatsApp   : 01642720525
\033[1;95m☞ Facebook    : https://www.facebook.com/GOD.OF.VIRTUU4L
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Corona-virus Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Reza ')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 01642720525✓')
	    psb('WellCome To Corona-Virus')
	    psb('Congratulations Corona-Virus Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ VIRUS✓')
	    psb('🔓Password ☆ Reza✓')
	    psb('Follow My Facebook Ariyan Reza✓')
